            ...
            <div className="max-w-7xl w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {vehicles.length === 0 ? (
                        ...
                        >No hay vehículos registrados.</p>
                    ) : (
                                ...
                                <div className="pt-2 border-t text-sm space-y-1">
                                    <div>
                                        <strong className="text-blue-700">
                                            Propietario:</strong> {vehicle.owner.fullName}<br />
                                        <span className="text-gray-500">{vehicle.owner.email}</span>
                                    </div>
                                    <div>
                                        <strong className="text-blue-700">
                                            Tenedor:</strong> {vehicle.holder.fullName}<br />
                                        <span className="text-gray-500">{vehicle.holder.email}</span>
                                    </div>
                                    <div>
                                        <strong className="text-blue-700">
                                            Conductor:</strong> {vehicle.driver.fullName}<br />
